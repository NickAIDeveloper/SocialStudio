        ...
        <div className="lg:sticky lg:top-20 space-y-5 bg-(--surface) rounded-2xl p-4 -m-4">
          ...
          <div className="glass-card p-5 space-y-4">
            ...
            <div className="rounded-xl overflow-hidden border border-(--line) bg-black">
                  ...
                  <>
                    ...
                    {overlayEnabled && overlayText && (
                      <>
                        ...
                        <div
                          className={`absolute inset-x-0 p-6 flex flex-col items-center ${
                            overlayStyle === 'editorial'
                              ? 'top-0 justify-center'
                              : TEXT_POSITION_CLASSES[textPosition]
                          }`}
                          style={overlayStyle === 'editorial' ? { height: '68%' } : undefined}
                        >
                          ...
                          <p
                            ...
                            style={{ fontSize: overlayStyle === 'editorial'
                              ? overlayText.length <= 20 ? 'clamp(28px, 8vw, 48px)'
                              : overlayText.length <= 35 ? 'clamp(24px, 7vw, 40px)'
                              : overlayText.length <= 50 ? 'clamp(20px, 5.5vw, 32px)'
                              : 'clamp(16px, 4.5vw, 26px)'
                              : 'clamp(24px, 7vw, 40px)'
                            }}
                          >
                            {overlayText}
              ...
              {/* IG action bar — decorative preview chrome, not interactive */}
              <div className="flex items-center justify-between px-3 py-2.5" aria-hidden="true">
                <div className="flex items-center gap-4">
                  ...
                  <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5" /></svg>
                </div>
                <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.25 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0 1 11.186 0Z" /></svg>
              </div>
